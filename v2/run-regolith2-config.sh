...
#Backgrounds
cp initial-background.png /usr/share/backgrounds/initial-background.png &&
    echo "regolith.wallpaper.file: /usr/share/backgrounds/initial-background.png
regolith.lockscreen.wallpaper.file: /usr/share/backgrounds/initial-background.png" regolith-look refresh >>$HOME/.config/regolith2/Xresources
